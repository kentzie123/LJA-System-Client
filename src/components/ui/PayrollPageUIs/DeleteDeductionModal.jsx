...
const DeleteDeductionModal = ({ isOpen, onClose, onConfirm, planName, isDeleting }) => {
      ...
      <div className="bg-base-100 rounded-xl shadow-2xl w-full max-w-sm border border-base-200 overflow-hidden transform transition-all scale-100">
        ...
        <div className="p-4 flex justify-between items-start">
          <div className="flex gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-base-content">Delete Strategy?</h3>
        ...
        <div className="px-6 py-2">
          <p className="text-sm text-base-content/80 leading-relaxed">
            Are you sure you want to delete <span className="font-bold text-base-content">"{planName}"</span>?
          </p>
          <div className="mt-3 p-3 bg-base-200 rounded-lg border border-base-300">
            <p className="text-xs opacity-70">
              <span className="font-bold">Warning:</span> All payment history and subscriber records associated with this plan will be permanently removed.
            </p>
          </div>
        </div>
