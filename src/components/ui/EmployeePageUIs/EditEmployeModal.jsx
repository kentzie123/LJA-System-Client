...
const EditEmployeeModal = ({ isOpen, onClose, employee }) => {
  ...
  // Helper function to format DB dates to YYYY-MM-DD for HTML input
  ...
  useEffect(() => {
    if (employee) {
      setFormData({
        ...
        password: "", // Password starts blank so COALESCE ignores it if unchanged
        ...
        <div className="py-4 px-6 overflow-y-auto custom-scrollbar">
          <form onSubmit={handleSubmit} noValidate className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <fieldset className="fieldset">
                  ...
                  <input type="text" name="fullname" className={`input input-bordered w-full text-xs ${errors.fullname ? "input-error" : ""}`} value={formData.fullname} onChange={handleChange} />
                ...
                <fieldset className="fieldset">
                  ...
                  <input type="email" name="email" className={`input input-bordered w-full text-xs ${errors.email ? "input-error" : ""}`} value={formData.email} onChange={handleChange} />
                ...
                <fieldset className="fieldset">
                  ...
                  <input type="text" name="contact_number" className="input input-bordered w-full text-xs" value={formData.contact_number} onChange={handleChange} />
                </fieldset>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <fieldset className="fieldset">
                  ...
                  <input type="text" name="employee_id" className={`input input-bordered w-full text-xs ${errors.employee_id ? "input-error" : ""}`} value={formData.employee_id} onChange={handleChange} />
                ...
                <fieldset className="fieldset">
                  ...
                  <input type="text" name="position" className={`input input-bordered w-full text-xs ${errors.position ? "input-error" : ""}`} value={formData.position} onChange={handleChange} />
                ...
                <fieldset className="fieldset">
                  ...
                  <input type="number" name="daily_rate" className={`input input-bordered w-full text-xs ${errors.daily_rate ? "input-error" : ""}`} value={formData.daily_rate} onChange={handleChange} />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <fieldset className="fieldset">
                  ...
                  <input type="text" name="place_of_birth" className="input input-bordered w-full text-xs" value={formData.place_of_birth} onChange={handleChange} />
                </fieldset>
                <fieldset className="fieldset">
                ...
                <fieldset className="fieldset md:col-span-2">
                  ...
                  <input type="text" name="residential_address" className="input input-bordered w-full text-xs" value={formData.residential_address} onChange={handleChange} />
                </fieldset>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <fieldset className="fieldset">
                  ...
                  <input type="text" name="sss_number" className="input input-bordered w-full text-xs" value={formData.sss_number} onChange={handleChange} />
                </fieldset>
                <fieldset className="fieldset">
                  <legend className="fieldset-legend text-xs font-semibold">PhilHealth Number</legend>
                  <input type="text" name="philhealth_number" className="input input-bordered w-full text-xs" value={formData.philhealth_number} onChange={handleChange} />
                </fieldset>
                <fieldset className="fieldset">
                  <legend className="fieldset-legend text-xs font-semibold">Pag-IBIG Number</legend>
                  <input type="text" name="pag_ibig_number" className="input input-bordered w-full text-xs" value={formData.pag_ibig_number} onChange={handleChange} />
                </fieldset>
                <fieldset className="fieldset">
                  <legend className="fieldset-legend text-xs font-semibold">TIN</legend>
                  <input type="text" name="tin_number" className="input input-bordered w-full text-xs" value={formData.tin_number} onChange={handleChange} />
                </fieldset>
                <fieldset className="fieldset">
                  <legend className="fieldset-legend text-xs font-semibold">Bank Name</legend>
                  <input type="text" name="bank_name" className="input input-bordered w-full text-xs" value={formData.bank_name} onChange={handleChange} />
                </fieldset>
                <fieldset className="fieldset">
                  <legend className="fieldset-legend text-xs font-semibold">Bank Account Number</legend>
                  <input type="text" name="bank_account_number" className="input input-bordered w-full text-xs" value={formData.bank_account_number} onChange={handleChange} />
                </fieldset>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <fieldset className="fieldset">
                  ...
                  <input type="text" name="emergency_contact_name" className="input input-bordered w-full text-xs" value={formData.emergency_contact_name} onChange={handleChange} />
                </fieldset>
                <fieldset className="fieldset">
                  <legend className="fieldset-legend text-xs font-semibold">Contact Number</legend>
                  <input type="text" name="emergency_contact_number" className="input input-bordered w-full text-xs" value={formData.emergency_contact_number} onChange={handleChange} />
                </fieldset>
                <fieldset className="fieldset md:col-span-2">
                  <legend className="fieldset-legend text-xs font-semibold">Relationship</legend>
                  <input type="text" name="emergency_relationship" className="input input-bordered w-full text-xs" value={formData.emergency_relationship} onChange={handleChange} />
                </fieldset>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-base-300">
              <button type="button" onClick={onClose} className="btn text-xs" disabled={isUpdatingUser}>
                Cancel
              </button>
              <button type="submit" className="btn btn-primary text-xs" disabled={isUpdatingUser}>
