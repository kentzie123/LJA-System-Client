...
import { X, Clock, Camera, FileText } from "lucide-react";
...
const CalendarDetailsModal = ({
  ...
  return (
    <>
      {/* 1. MAIN DETAILS MODAL - Using native dialog with showModal() */}
          ...
          <div className="p-4 sm:p-5 overflow-y-auto custom-scrollbar flex-1 bg-base-100">
            ...
            {selectedCell.status === "Leave" && selectedCell.leave ? (
              ...
              <div className="flex flex-col gap-4">
                ...
                {/* SUMMARY */}
                <div className="bg-base-200/50 border border-base-200 rounded-xl p-3 sm:p-4">
      ...
      {/* 2. PHOTO VIEWER MODAL - Using native dialog with showModal() */}
